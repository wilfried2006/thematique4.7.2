...
namespace LamyThematique.Web.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        private readonly IGetFiltersDataService _getFiltersDataService;

        public HomeController(IGetUserPageService getUserPageService, IGetFiltersDataService getFiltersDataService)
        {
            //_logger = logger;
            _getUserPageService = getUserPageService;
            _getFiltersDataService = getFiltersDataService;
        }
        ...
        {
            return View(await _getFiltersDataService.GetSearchResultPageAsync());
